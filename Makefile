...
.PRECIOUS:
.SECONDARY:
.PHONY: all red blue clean tidy compare tools decrypt
...
decrypt:
	@encryption/decrypt.ts ./baserom.gb ./home/audio.encrypted.bin ./home/audio.asm
	@encryption/decrypt.ts ./baserom.gb ./home/init.encrypted.bin ./home/init.asm
	@encryption/decrypt.ts ./baserom.gb ./home/overworld.encrypted.bin ./home/overworld.asm
