...
ItemUseBall:
	jpIfInField ItemUseNotTime	; 戦闘外ではボールは使えない
...
.skip2
	...
	; X = (W >= 256 ? (W | 0x000000ff) : W)
	ld a, [H_QUOTIENT + 2]
	and a
	jr z, .skip3			; X = W
	ld a, 255
	ld [H_QUOTIENT + 3], a	; X = W | 0x000000ff
...
ItemUseEvoStone:
	jpIfInBattle ItemUseNotTime	; 戦闘中では使えない
...
.updateInBattleFaintedData
	jrIfInField .compareCurrentHPToMaxHP
	push hl
	push de
	push bc
...
.inBattle
	...
	jrIfInWildBattle .skipWakingUpEnemyParty
